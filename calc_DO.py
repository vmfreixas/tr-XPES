...
# - coreOrb -> MO from where the electron is removed in the cation
# - valeOrb -> MO from where the electron transition in the neutral
...
def calc_DO(neutralFile, cationFile, Nbf, Nocc, coreOrb, valeOrb,
    ntrlOrb, channel):
